export default {
	...
	table: {
		...
		noActorRemove: 'لا يمكن حذف ممثل معلوماته غير مكتملة',
	},
	enouphActors: 'ألا يكفي 3 ممثلين للتمثيل في فيلم غير حقيقي!',
	noActorsNoMovie: 'لا يكتمل نجاح الفيلم إلا بوجود ممثلين',
}
